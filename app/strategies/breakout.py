    ...
    def __init__(self, parameters: dict | None = None):
        ...
        Args:
            parameters: Strategy parameters
                - lookback_period: Period to identify
                  support/resistance (default: 20)
                - breakout_threshold: Percentage above/below
                  level for breakout (default: 0.02)
                - volume_confirmation: Require volume
                  confirmation (default: True)
                - volume_multiplier: Volume must be X times
                  average (default: 1.5)
        """
        default_params = {
            "lookback_period": 20,
